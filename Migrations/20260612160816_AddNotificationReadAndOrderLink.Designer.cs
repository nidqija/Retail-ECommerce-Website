...
namespace RetailECommerce.Migrations
{
    ...
    [Migration("20260612160816_AddNotificationReadAndOrderLink")]
    partial class AddNotificationReadAndOrderLink
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RetailECommerce.Models.UsedDiscount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RetailECommerce.Models.UsedDiscount", b =>
                {
                    b.HasOne("RetailECommerce.Models.Discount", "Discount")
                        .WithMany()
